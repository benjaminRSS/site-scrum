document.addEventListener("DOMContentLoaded", () => {
	...
	const nextButtonText = document.querySelector("#ecrito");
	...
	function changeState(title, contentContainer, state) {
	  if (title && contentContainer) {
		switch (state) {
		  case 1:
			title.innerHTML =
			  "<h1>Chapitre 1 : Lancement du Projet - Préparation et Vision</h1>";
		  ...
		  case 2:
			title.innerHTML =
			  "<h1>Chapitre 2 : Planification - Organisation et Structuration</h1>";
			contentContainer.innerHTML = `
		  ...
		  case 3:
			title.innerHTML =
			  "<h1>Chapitre 3 : Exécution - Sprint et Développement Itératif</h1>";
			contentContainer.innerHTML = `
		  ...
		  case 4:
			title.innerHTML =
			  "<h1>Chapitre 4 : Revue - Contrôle de Qualité et Feedback</h1>";
			contentContainer.innerHTML = `<div class="margebottom">
		  ...
		  case 5:
			title.innerHTML =
			  "<h1>Chapitre 5 : Rétrospective - Amélioration Continue</h1>";
			contentContainer.innerHTML = `<p>La rétrospective de sprint est une réunion interne consacrée à l’analyse des performances de l’équipe. Elle se concentre sur les <b>succès</b>, les <b>axes d’amélioration</b>, et les <b>actions à entreprendre</b> pour optimiser les processus. Tous les membres participent activement pour exprimer leur ressenti et proposer des idées d’amélioration.</p>
			
			<img class="both" src="../images/ch5-img1.png" alt="Illustration retrospective" width=600px>
		  ...
		  case 6:
			title.innerHTML =
			  "<h1>Chapitre 6 : Livraison - Validation et Mise en Production</h1>";
			contentContainer.innerHTML = `<img class="margetop" src="../images/ch6-img1.jpg" alt="Illustration réussite" width=600px>
	...
	function updateButtonText() {
	  if (chapitreActuel === 6) {
		nextButtonText.textContent = "Terminer";
	  }
	}
  
	// Mise à jour du fil d'ariane
	function updateActiveStep() {
		const activeStep = document.querySelector(".chap.actif");
		if (activeStep && activeStep.nextElementSibling) {
			...
			const nextChap = activeStep.nextElementSibling.nextElementSibling; 
